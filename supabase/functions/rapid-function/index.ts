// supabase/functions/rapid-function/index.ts
//
// Sicherer Proxy für Claude-Anfragen aus den Great-Hair-Day-Apps
// (Wörni in team.html, Claude-Anfrage in salon-checklist.html).
// Der Browser schickt NIE model/max_tokens/system — nur einen
// festen "zweck" und den Nutzertext. Ohne gültige Supabase-Session
// gibt es 401.
//
// Deploy: supabase functions deploy rapid-function
// Secret: supabase secrets set ANTHROPIC_API_KEY=sk-ant-...
// Zusätzlich im Anthropic-Dashboard ein Monatslimit setzen.
...
// Systemprompts serverseitig festgelegt — der Browser wählt nur per `zweck`.
...
const MAX_TOKENS = 400;          // fest, nicht aus dem Body
...
Deno.serve(async (req) => {
  ...
  // 2) Body validieren — nur zweck + text zählen
  ...
  // 3) Anthropic aufrufen — Modell/Prompt/Limit fest
